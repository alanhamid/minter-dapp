...
const description = "An NFT collection of programmatically  generated unique images.  Each NFT of this collection gives the owners an option of purchasing 0.00001% of the stock of the Texila, Inc. ";
...
const GENERIC_DESCRIPTION = "You need a CJC NFT to enter the Camel Jockey Club"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreicxlh4zscvixsmi436ksyj7xpxcxnuocxsw5xxgjbkxgi4qfsiogq"; // Replace with your generic image that will display for all NFTs pre-reveal.
